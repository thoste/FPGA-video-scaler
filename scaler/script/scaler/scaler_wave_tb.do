...
# Framebuffer read
add wave -noupdate -expand -group {Framebuffer read}        -radix unsigned   -label fb_rd_addr_a_i   /tb_scaler/i_scaler/fb_rd_addr_a_i
add wave -noupdate -expand -group {Framebuffer read}        -radix unsigned   -label fb_rd_addr_b_i   /tb_scaler/i_scaler/fb_rd_addr_b_i
add wave -noupdate -expand -group {Framebuffer read}        -radix unsigned   -label fb_rd_addr_c_i   /tb_scaler/i_scaler/fb_rd_addr_c_i
add wave -noupdate -expand -group {Framebuffer read}        -radix unsigned   -label fb_rd_addr_d_i   /tb_scaler/i_scaler/fb_rd_addr_d_i
add wave -noupdate -expand -group {Framebuffer read}        -radix unsigned   -label fb_data_a_o      /tb_scaler/i_scaler/fb_data_a_o
add wave -noupdate -expand -group {Framebuffer read}        -radix unsigned   -label fb_data_b_o      /tb_scaler/i_scaler/fb_data_b_o
add wave -noupdate -expand -group {Framebuffer read}        -radix unsigned   -label fb_data_c_o      /tb_scaler/i_scaler/fb_data_c_o
add wave -noupdate -expand -group {Framebuffer read}        -radix unsigned   -label fb_data_d_o      /tb_scaler/i_scaler/fb_data_d_o
...
# Kernel window
add wave -noupdate -expand -group {Kernel window} -radix unsigned    -label x1      /tb_scaler/i_scaler/x1_int
add wave -noupdate -expand -group {Kernel window} -radix unsigned    -label x2      /tb_scaler/i_scaler/x2_int
add wave -noupdate -expand -group {Kernel window} -radix unsigned    -label y1      /tb_scaler/i_scaler/y1_int
add wave -noupdate -expand -group {Kernel window} -radix unsigned    -label y2      /tb_scaler/i_scaler/y2_int
add wave -noupdate -expand -group {Kernel window} -radix unsigned    -label pix1    /tb_scaler/i_scaler/pix1_int
add wave -noupdate -expand -group {Kernel window} -radix unsigned    -label pix2    /tb_scaler/i_scaler/pix2_int
add wave -noupdate -expand -group {Kernel window} -radix unsigned    -label pix3    /tb_scaler/i_scaler/pix3_int
add wave -noupdate -expand -group {Kernel window} -radix unsigned    -label pix4    /tb_scaler/i_scaler/pix4_int
