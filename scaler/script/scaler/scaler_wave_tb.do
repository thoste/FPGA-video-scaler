...
add wave -noupdate -expand -group {Framebuffer} -radix hexadecimal 	-label out_count 		/tb_scaler/i_scaler/out_count
add wave -noupdate -expand -group {Framebuffer} -radix hexadecimal 	-label fb_rd_addr_i 	/tb_scaler/i_scaler/fb_rd_addr_i

# X
add wave -noupdate -expand -group {X} -radix hexadecimal 	-label x_count 	/tb_scaler/i_scaler/x_count
add wave -noupdate -expand -group {X} -radix hexadecimal 	-label dx 		/tb_scaler/i_scaler/dx

# Y
add wave -noupdate -expand -group {Y} -radix hexadecimal 	-label y_count 	/tb_scaler/i_scaler/y_count
add wave -noupdate -expand -group {Y} -radix hexadecimal 	-label dy 		/tb_scaler/i_scaler/dy

add wave -noupdate -expand -group {fixed} -radix ufixed 	-label vid_width_ufixed 	sim:/tb_scaler/i_scaler/vid_width_ufixed
